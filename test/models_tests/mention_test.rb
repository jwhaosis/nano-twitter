...
describe "Mention Model tests" do
  before do
    User.delete_all
    Tweet.delete_all
    Mention.delete_all
    ...
    @correctmention = Mention.new(mentioned_user_id: @dummycorrectuser.id, tweet_id: @correcttweet.id)
    @incorrectmention1 = Mention.new(mentioned_user_id: @dummycorrectuser.id)
    @incorrectmention2 = Mention.new(mentioned_user_id: @correcttweet.id)
  end
  ...
  it "must have a user id" do
    @incorrectmention1.save.must_equal(true)
  end

  it "must have a tweet id" do
    @incorrectmention2.save.must_equal(true)
  end
end
